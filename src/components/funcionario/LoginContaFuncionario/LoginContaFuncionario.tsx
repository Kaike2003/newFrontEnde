...
export default function LoginContaFuncionario() {

    const { logarUtilizadorFuncionario, logadoFuncionario } = useContext(AuthContext)
                ...
                <div className="lg:w-2/5 md:w-1/2 w-2/3">
                    ...
                    <Formik
                        ...
                        onSubmit={async values => {
                            ...
                            const palavraPasse = values.palavra_passe
                            return logarUtilizadorFuncionario(email, palavraPasse)
                        }}
                    >
