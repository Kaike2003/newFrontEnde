...
export default function AutenticarContaFuncionario() {

    const navigate = useNavigate()

    const SchemaCriarContaFuncionario = object({
        ...
        <div className='h-screen bg-indigo-100 flex justify-center items-center'>
            ...
            <div className="lg:w-2/5 md:w-1/2 w-2/3">
                ...
                <Formik
                    ...
                    validationSchema={SchemaCriarContaFuncionario}
                    validateOnChange
                    onSubmit={async values => {

                        const result_api = await api.put("/funcionario/autenticar_funcionario", {
