...
export default function LoginContaAdmin() {

    const { logarUtilizadorAdmin, logadoAdmin } = useContext(AuthContext)
                ...
                <div className="lg:w-2/5 md:w-1/2 w-2/3">
                    ...
                    <Formik
                        ...
                        onSubmit={async values => {
                            ...
                            return logarUtilizadorAdmin(email, palavra_passe)
