...
export default function TabelaPerdido() {
            ...
            <Box sx={{ display: 'flex', gap: '0px' }}>
                ...
                < Tooltip placement="right" title="Detalhes">
                    <IconButton color="info"
                        onClick={() => {
                            ...
                            navigate(`/suchen/${tipo_utilizador}/perdido/detalhes`)
                        }}
                    >
                ...
                < Tooltip placement="right" title="Editar">
                    <IconButton color="primary"
                        onClick={() => {
                            setIdDocumento(`${row.original.id}`)
                            navigate(`/suchen/${tipo_utilizador}/perdido/editar`)
                        }}
                    >
                        <CreateRoundedIcon />
                    </IconButton>
                ...
                < Tooltip placement="right" title="Deletar">
                    <IconButton color="error"
                        onClick={() => {
                            setIdDocumento(`${row.original.id}`)
                            navigate(`/suchen/${tipo_utilizador}/perdido/deletar`)
                        }}
                    >
                        <DeleteRoundedIcon />
                    </IconButton>
