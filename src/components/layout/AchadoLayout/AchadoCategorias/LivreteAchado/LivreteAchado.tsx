...
function LivreteAchado() {
    ...
    const callBack = useCallback(async () => {
        ...
        const response = await api.get("/publico/listar_todos_livrete_achados_limite/6")
    ...
    async function fetchData() {
        ...
        const response = await api.get(`/publico/listar_todos_livrete_achados_limite/${limite}`)
        const newData = response.data
        setData(newData)
