...
export default function DetalhesAchado() {
                        ...
                        <div className=''>
                            <div className='bg-indigo-100 flex items-center justify-center h-full'>
                                ...
                                <section className="w-[100%] p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                                    ...
                                    <h1 className="text-xl font-bold text-black capitalize dark:text-white">DETALHES DO OBJECTO ACHADO</h1>
                                        ...
                                        onSubmit={async values => {
                                            ...
                                            dataUtilizador.map(async ({ id, email }: { id: string, email: string }) => {
                                                ...
                                                if (email === emailUtilizador) {
                                                    await api.put(`/${tipo_utilizador}/publicar_documento/${idUtilizador}/${idDocumento}`
                                                    ).then(() => {
                                                        ...
                                                        setTimeout(() => {
                                                            ...
                                                            return navigate(`/suchen/${tipo_utilizador}/achado`)

                                                        }, 500)

                                                    }).catch((error) => {

                                                        toast.error('Adicione uma foto ao seu documento')
