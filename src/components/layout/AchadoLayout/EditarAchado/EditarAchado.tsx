...
export default function EditarAchado() {
                        ...
                        <div className=''>
                            <div className='bg-indigo-100 flex items-center justify-center h-full'>
                                ...
                                <section className="w-[100%] p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                                    <h1 className="text-xl font-bold text-black capitalize dark:text-white">EDITAR OBJECTO ACHADO</h1>
                                    <Formik
                                        ...
                                        onSubmit={async values => {
                                            ...
                                            dataUtilizador.map(async ({ id, email }: { id: string, email: string }) => {
                                                ...
                                                if (email === emailUtilizador) {
                                                    ...
                                                    const result_api = await api.put(`/${rota}/atualizar_documento_achado_${rota}/${id}/${idDocumento}`,
                                                        formData
                                                        ,
                                                        {
                                                            headers: {
