...
export default function DeletarAchadoAdmin() {
                        ...
                        <div className=''>
                            <div className='bg-indigo-100 flex items-center justify-center h-full'>
                                ...
                                <section className="w-[100%] p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                                    ...
                                    <h1 className="text-xl font-bold text-black capitalize dark:text-white">DELETAR OBJECTO ACHADO</h1>
                                                ...
                                                if (email === emailUtilizador) {
                                                    ...
                                                    if (result_api.data) {
                                                        ...
                                                        setTimeout(() => {
                                                            ...
                                                            return navigate(`/suchen/${tipo_utilizador}/dashboard/achados`)
