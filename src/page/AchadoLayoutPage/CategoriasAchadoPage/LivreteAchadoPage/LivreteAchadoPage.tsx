...
import LivreteAchado from '../../../../components/layout/AchadoLayout/AchadoCategorias/LivreteAchado/LivreteAchado'
...
import LivreteAchadoPesquisado from '../../../../components/layout/AchadoLayout/AchadoCategorias/LivreteAchado/LivreteAchadoPesquisado'


function LivreteAchadoPage() {

  const [categoria, setCategoria] = useStoreCategoria((state) => [state.categoria, state.setCategoria])

  const [pesquisarLivreteAchado, setPesquisarLivreteAchado] = useStoreLivrete((state) => [state.pesquisarLivreteAchado, state.setPesquisarLivreteAchado])
    ...
    <div>
      ...
      <div className='flex justify-between place-items-center mx-5 mt-2'>
        <div className='flex gap-4'>
          ...
          {pesquisarLivreteAchado === true ?
            ...
            <div
              ...
              onClick={() => {
                setPesquisarLivreteAchado(false)
                setPesquisar("")
              }}
            >
        ...
        <input id="email" type="text" className="px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300" placeholder="Pesquisar"
          ...
          onKeyDown={async (e) => {
            if (e.code === "Enter") {
              if (pesquisarLivreteAchado === false) {
                ...
                setPesquisarLivreteAchado(true)
                setPesquisar("")
              } else {
...
export default LivreteAchadoPage