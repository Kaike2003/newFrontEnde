...
import CartaConducaoAchado from '../../../../components/layout/AchadoLayout/AchadoCategorias/CartaConducaoAchado/CartaConducaoAchado'
...
import CartaConducaoAchadoPesquisado from '../../../../components/layout/AchadoLayout/AchadoCategorias/CartaConducaoAchado/CartaConducaoAchadoPesquisado'

function CartaConducaoAchadoPage() {

  const [categoria, setCategoria] = useStoreCategoria((state) => [state.categoria, state.setCategoria])

  const [pesquisarCartaConducaoAchado, setPesquisarCartaConducaoAchado] = useStorePesquisarCartaConducao((state) => [state.pesquisarCartaConducaoAchado, state.setPesquisarCartaConducaoAchado])
    ...
    <div>
      ...
      <div className='flex justify-between place-items-center mx-5 mt-2'>
        <div className='flex gap-4'>
          ...
          {pesquisarCartaConducaoAchado === true ?
            ...
            <div
              ...
              onClick={() => {
                setPesquisarCartaConducaoAchado(false)
                setPesquisar("")
              }}
            >
        ...
        <input id="email" type="text" className="px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300" placeholder="Pesquisar"
          ...
          onKeyDown={async (e) => {
            if (e.code === "Enter") {
              if (pesquisarCartaConducaoAchado === false) {
                ...
                setPesquisarCartaConducaoAchado(true)
                setPesquisar("")
              } else {
...
export default CartaConducaoAchadoPage